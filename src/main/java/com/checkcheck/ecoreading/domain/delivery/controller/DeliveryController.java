...
public class DeliveryController {
    ...
    public String completeTakeBook(@ModelAttribute DeliveryDTO deliveryDTO, @ModelAttribute BookMainDTO booksDTO) {
        transactionService.updateTransactions(booksDTO);  // Transaction 테이블 값 변경
        deliveryService.insertDelivery(deliveryDTO);  // Delivery 테이블 값 추가
        userService.updateUserTotalPoint(booksDTO);  // User 테이블 5 책갈피 차감
